...
<Image source={require('../images/Use.png')} style={{height:80, width:80,margin:40, borderRadius:40 }}/> 
             <Text style={{color:'#fff', fontSize:18, fontWeight:'bold', margin:20,bottom:20}}>Leah Makgatho</Text> 
        </View>
        </View>
